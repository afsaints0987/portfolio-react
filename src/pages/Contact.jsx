        ...
        <MotionContainer>
            ...
            {success && <p className="text-success">{message}</p>}
                <ul className="contact-icons p-0 mt-2">
                    <li className="contact-icon"><FaIcons.FaMapMarkerAlt className="mx-2"/> Philippines</li>
                    <li className="contact-icon my-2"><FaIcons.FaEnvelope className="mx-2"/> afsaints0987@gmail.com</li>
